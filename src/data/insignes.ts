...
export const INSIGNES_CATALOG: InsigneDef[] = [
  ...
  { id: 'appareil_photo', label: 'Appareil photo', category: 'auto', labelEndroit: 'Amour de la photographie' },
  ...
  { id: 'lyre_tete_mort', label: 'Lyre + tête de mort', category: 'grand_maitre', labelEndroit: 'Chanteur digne de paillardes' },
